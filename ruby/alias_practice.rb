...
#create method for creating data structure and storing each process
...
store_processes(consonant_checker(vowel_checker(name_order(name_array(first_name, last_name)))))